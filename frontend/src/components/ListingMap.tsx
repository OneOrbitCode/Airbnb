...
export default function ListingMap({ listings, categoryTitle }: ListingMapProps) {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-140px)] min-h-[420px] sm:min-h-[520px] rounded-2xl overflow-hidden shadow-md border border-gray-200 dark:border-neutral-800">
      
      {/* Category / Section Floating Banner */}
      <div className="absolute top-3 left-3 sm:top-4 sm:left-4 z-20 bg-white/95 dark:bg-[#1e1e1e]/95 backdrop-blur-md px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 dark:border-neutral-700 flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs font-semibold text-neutral-900 dark:text-white">
        <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#FF385C] animate-pulse flex-shrink-0" />
